#ifndef ALCATA_DEFINITIONS_H
#define ALCATA_DEFINITIONS_H

#define TRUE 1
#define FALSE 0

#define ALCATA_PP   FALSE // Set to TRUE to enable if using ALCATA++ 
#define USE_MTB     TRUE  // If using MTB set to TRUE and Intrumentation Based set to False
